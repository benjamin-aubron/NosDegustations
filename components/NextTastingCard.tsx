...
import deleteNextTasting from "@/app/prochaines-degustations/deleteTasting";
  ...
  return (
    <Card className="my-2 p-4 rounded-lg cursor-pointer" onClick={onClick}>
      <div className="flex justify-between items-center">
        ...
        <div onClick={() => {deleteNextTasting(id)}} className={`${pathname === "/" ? "hidden" : "flex"} flex-col justify-center items-end text-sm text-neutral-600 bg-red-50 hover:bg-red-200 p-2 cursor-pointer rounded-sm group`}>
